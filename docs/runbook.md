...
3. Set env vars in Coolify UI: `LITELLM_BASE_URL`, `LITELLM_API_KEY`, `AI_MODEL_CHAT`, `AI_MODEL_COPILOT`, `ADMIN_PASSWORD`, `CORS_ORIGINS` (the public origin), `NEXT_PUBLIC_API_URL` (the public origin — baked at web build).
